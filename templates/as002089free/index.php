...
<head>
	...
	$menu_id = 0;
	if (JRequest::getVar('view') != 'form' && !$hideByView && !$hideByEdit)
	{
...
<body class="<?php echo $option . " view-" . $view . " task-" . $task . " itemid-" . $itemid . " body__" . $pageClass . " " . $classMobile . " " . $classTablet;?>">
    ...
    <div id="footer-wrapper">
        ...
        <?php if ($this->countModules('as-footer-3') && !$hideByView && !$hideByEdit && !$hideByOption): ?>
        <div id="footer-row-3">
            <div class="row-wrapper">
        ...
        <div id="copyright-row" role="contentinfo">
            <div id="copyright">
                ...
                <h3 class="siteName"><?php echo $sitename; ?></h3>
                	<?php if($slogan) : ?>
                	<h2 class="siteSlogan"><?php echo $slogan;?></h2>
                	<?php endif; ?>	
                <?php endif; ?>
